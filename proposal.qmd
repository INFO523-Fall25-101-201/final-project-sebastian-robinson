---
title: "How Do LLM Models Play Against Base Game AI"
subtitle: "Proposal"
author: 
  - name: "Sebastian Robinson (Solo)"
    affiliations:
      - name: "College of Information Science, University of Arizona"
description: "Analysis of per turn gameplay to understand how and when a LLM will change its strategy."
format:
  html:
    code-tools: false
    code-overflow: wrap
...
I will use the LLM's own recording of its reasoning found in PersonaChanges.csv to validate I have correctly identified a strategy pivot