...
The datasets are courtesy of Dr. Chen and his on going research into LLM self play.
...
-   Tourism per turn was omitted as the LLM never used it. Removing this can skew strategy analysis and reasoning across all players, however the focus is on the LLM alone.
